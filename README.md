...
1) Raspberry Pi OS Lite, a port of Debian Trixie with no desktop environment. I used a Raspberry Pi due to its low consumption but you can set it up on any Debian-compatible system.
